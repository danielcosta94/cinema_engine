...
class ShoppingCartItemFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $shoppingCartItem1->setSaleItem($this->getReference(sprintf("%s%s", SaleItemFixtures::REFERENCE_PREFIX, SaleItemFixtures::BARCODE_1)));
        ...
        $shoppingCartItem2->setSaleItem($this->getReference(sprintf("%s%s", SaleItemFixtures::REFERENCE_PREFIX, SaleItemFixtures::BARCODE_2)));
        ...
        $shoppingCartItem3->setSaleItem($this->getReference(sprintf("%s%s", SaleItemFixtures::REFERENCE_PREFIX, SaleItemFixtures::BARCODE_3)));
        ...
        $shoppingCartItem4->setSaleItem($this->getReference(sprintf("%s%s", SaleItemFixtures::REFERENCE_PREFIX, SaleItemFixtures::BARCODE_4)));
        ...
        $shoppingCartItem5->setSaleItem($this->getReference(sprintf("%s%s", SaleItemFixtures::REFERENCE_PREFIX, SaleItemFixtures::BARCODE_2)));
